...
#define K 622.8f
//
#define RightAngleTimeCountPre 105//直角转弯时间
#define PointDifference 35//CCD直角判断左右Point位置差值
#define RightAngleJudgeCountPre 3//CCD直角判断次数
u8 Flag_Target;
...
{    
	...
	{   
		 ...
		 {
			 //直角弯操作
			 //持续50ms*RightAngleTimeCount时间的直角弯模式
			 RightAngleTimeCount--;
...
{ 
	 static u16 i,j,Left,Right,Last_CCD_Zhongzhi,Left_Point,Right_Point;
	 ...
	 for(j = 118;j>5; j--)//寻找右边跳变沿
  {
	...
	CCD_ChaZhi = Right_Point-Left_Point;
	
	////////////////////////////////////
	if((Right_Point-Left_Point > PointDifference) 
