...
{ 
   ...
   u32 temp = 0;
	...
	for(i = 5;i<118; i++)   //寻找左边跳变沿
	{
		...
		//左边的点////////////////////////
//		if(ADV[i]<CCD_Yuzhi&&ADV[i+1]<CCD_Yuzhi
//				&&ADV[i+2]<CCD_Yuzhi&&ADV[i+3]<CCD_Yuzhi)
//		{	
//			Left_Point=i;
//			break;	
//		}
...
//		//右边的点////////////////////////
//		if(ADV[j]<CCD_Yuzhi&&ADV[j+1]<CCD_Yuzhi
//				&&ADV[j+2]<CCD_Yuzhi&&ADV[j+3]<CCD_Yuzhi)
//		{	
//		  Right_Point=j;
//		  break;	
//		}
